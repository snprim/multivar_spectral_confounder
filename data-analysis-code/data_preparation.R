...
#################################################################
###### If you do not have access to Medicare data, ##############
###### use data_preparation_synthetic.R instead. ################
#################################################################
...
zcta_order_df <- data.frame(ZCTA5CE20 = zcta_order)
data_south_shape <- right_join(data_south_shape, zcta_order_df)
